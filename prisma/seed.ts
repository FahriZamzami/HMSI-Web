import { PrismaClient, UserRole, DivisionRole, MemberRole, Prisma } from '@prisma/client'
import * as bcrypt from 'bcrypt'

// Prisma v6 otomatis membaca DATABASE_URL dari file .env di root proyek saat runtime
...
async function main() {
    ...
    try {
        ...
        // PERBAIKAN: Mengubah `lable` yang typo menjadi `table`
